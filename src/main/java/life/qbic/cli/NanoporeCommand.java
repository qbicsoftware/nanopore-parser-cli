...
/**
 * Abstraction of command-line arguments that will be passed to {@link NanoporeTool} at construction time.
 */
@Command(
   name="Nanopore",
   description="A Client for running nanopore-parser. nanopore-parser-cli is designed to interoperate with current QBiC Server Infrastructure")
public class NanoporeCommand extends AbstractCommand {
